...
int main ()
{
   Contact contact; // contact struct to gather information
   getContactInfo(contact); // get the contact information
   displayContactInfo(contact); // display contact information
...
void displayContactInfo(Contact &contact)
{
   ...
   cout << "Work email: " << contact.email.workEmail << endl;
}
